    ...
    <div className="min-h-screen bg-disney-dark-blue pb-20">
      ...
      <main className="pt-24 px-4 md:px-6 max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <CollapsibleContent className={openSection === 'profile' ? 'block' : 'hidden'}>
        ...
        <section className="mb-8">
          ...
          <CollapsibleContent className={openSection === 'password' ? 'block' : 'hidden'}>
            <Card className="bg-disney-secondary-blue border-disney-gray-700">
              <CardContent className="pt-6">
                <Form {...passwordForm}>
        ...
        <section className="mb-8">
          ...
          <CollapsibleContent className={openSection === 'notifications' ? 'block' : 'hidden'}>
            <Card className="bg-disney-secondary-blue border-disney-gray-700">
              <CardContent className="pt-6">
        ...
        <section className="mb-8">
          <CollapsibleTrigger 
            className="flex justify-between items-center w-full mb-4 text-left"
            onClick={() => setOpenSection(openSection === 'playback' ? null : 'playback')}
          >
            <div className="flex items-center">
          ...
          <CollapsibleContent className={openSection === 'playback' ? 'block' : 'hidden'}>
            <Card className="bg-disney-secondary-blue border-disney-gray-700">
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
        ...
        <section className="mb-8">
          ...
          <CollapsibleContent className={openSection === 'privacy' ? 'block' : 'hidden'}>
            <Card className="bg-disney-secondary-blue border-disney-gray-700">
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
